            ...
            <div className="info" id={`${windowId}header`}>
                <div className="user">
                    <a href='https://www.instagram.com/aura.reykjavik/'>
                        <div className="profile-pic"><img src="ig/profile.jpg" alt=""/></div>
                    </a>
                ...
                <img src="ig/option.png" className="options" alt=""/>
            </div>
            <div className="post-image"/>
            <div className="post-content">
                <div className="reaction-wrapper">
                    <a href='https://www.instagram.com/direct/t/111953607055598' className="icon">
                        <svg aria-label="Unlike" fill="#ff3040" height="24"
                    ...
                    <svg aria-label="Comment" className="icon" height="24"
                         role="img" viewBox="0 0 24 24" width="24">
                        <path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none"
                              stroke="currentColor"
                              strokeLinejoin="round" strokeWidth="2"></path>
                    </svg>
                    <svg aria-label="Share" className="icon" height="24"
                         role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <svg aria-label="Save" className="icon save" height="24"
                         role="img" viewBox="0 0 24 24" width="24">
                ...
                <h4 className="likes">
                    ...
                    Liked by <strong>Inuk</strong> and <strong>others</strong></h4>
